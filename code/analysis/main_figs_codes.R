...
s <- "balanced_3_75_3"
plot(i, fdmax_l[[s]][i], ylim=c(0,1400), type="n", xlab="Genes chosen", ylab="False discoveries", main="Balanced, n=3")
...
s <- "unbalanced_3_75_3"
plot(i, fdmax_l[[s]][i], ylim=c(0,1400), type="n", xlab="Genes chosen", ylab="False discoveries", main="Unbalanced, n=3")
lines(i,fd_l[[s]][i,1],col="green",lwd=2)
lines(i,fd_l[[s]][i,2],col="green",lwd=2, lty=2)
lines(i,fd_l[[s]][i,3],col="blue",lwd=2)
lines(i,fd_l[[s]][i,4],col="blue",lwd=2, lty=2)
...
s <- "balanced_5_75_3"
plot(i, fdmax_l[[s]][i], ylim=c(0,1400), type="n", xlab="Genes chosen", ylab="False discoveries", main="Balanced, n=5")
lines(i,fd_l[[s]][i,1],col="green",lwd=2)
lines(i,fd_l[[s]][i,2],col="green",lwd=2, lty=2)
lines(i,fd_l[[s]][i,3],col="blue",lwd=2)
lines(i,fd_l[[s]][i,4],col="blue",lwd=2, lty=2)
...
s <- "unbalanced_5_75_3"
plot(i, fdmax_l[[s]][i], ylim=c(0,1400), type="n", xlab="Genes chosen", ylab="False discoveries", main="Unbalanced, n=5")
lines(i,fd_l[[s]][i,1],col="green",lwd=2)
lines(i,fd_l[[s]][i,2],col="green",lwd=2, lty=2)
lines(i,fd_l[[s]][i,3],col="blue",lwd=2)
lines(i,fd_l[[s]][i,4],col="blue",lwd=2, lty=2)
...
l <- list("DEJU-edgeR" = sigDEUgenes[[1]],
          "DEU-edgeR" = sigDEUgenes[[2]])

colors <- c("blue", "grey")
v <- venn.diagram(l, filename = NULL, disable.logging = TRUE, 
             main=NULL, print.mode=c("raw", "percent"),
             fill = colors, lwd=1)
pdf(paste0(fig, "fig_4A.pdf"), height = 2.5, width = 2.5)
grid.arrange(v)
dev.off()
...
pdf(paste0(fig, "fig_4B_1.pdf"), height = 8.5, width = 8.5)
par(mfrow=c(2,1))
...
# svg(paste0(fig, "fig_4B_1.svg"), height = 8.5, width = 8.5)
# par(mfrow=c(2,1))
# plotJunc(DEU$sp, geneid=g, genecol="Symbol", annotation=IE_J$IE_annot)
# plotJunc(DEJU$sp, geneid=g, genecol="Symbol", annotation=IE_J$IE_annot)
# dev.off()
...
set_name <- c("DEJU-edgeR", "DEU-edgeR", 
